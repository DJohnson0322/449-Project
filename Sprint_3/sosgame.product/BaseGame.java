...
public abstract class BaseGame
{
    ...
    protected boolean checkSOS(int r, int c)
    {
        ...
        for (int[] d : dirs)
        {
            ...
            if (placed == 'S')
            {
                if (inside(r + dr, c + dc, size) && inside(r + 2*dr, c + 2*dc, size))
                {
                    if (g[r + dr][c + dc] == 'O' && g[r + 2*dr][c + 2*dc] == 'S')
                    {
                        scoredLines.add(new SOSLine(r, c, r + 2*dr, c + 2*dc, currentPlayer));
                        return true;
                    }
                }
                ...
                if (inside(r - dr, c - dc, size) && inside(r - 2*dr, c - 2*dc, size))
                {
                    if (g[r - dr][c - dc] == 'O' && g[r - 2*dr][c - 2*dc] == 'S')
                    {
                        scoredLines.add(new SOSLine(r - 2*dr, c - 2*dc, r, c, currentPlayer));
                        return true;
                    }
                }
            }
            ...
            if (placed == 'O')
            {
                if (inside(r - dr, c - dc, size) && inside(r + dr, c + dc, size))
                {
                    if (g[r - dr][c - dc] == 'S' && g[r + dr][c + dc] == 'S')
                    {
                        scoredLines.add(new SOSLine(r - dr, c - dc, r + dr, c + dc, currentPlayer));
                        return true;
                    }
                }
            }
